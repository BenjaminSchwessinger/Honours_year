...
name=Pst79_run2_1d # change to only one run
short=/short/sd34/ap5514
###
INPUT=$short/basecalling/basecalled_albacore2110
OUTPUT=$short/basecalling/quality_control/1d_separate_qc/run2
...
cp ${INPUT}/Pst79_[2]/*tar.gz TAR_FILES/. # added basecall files to the node. only one run
