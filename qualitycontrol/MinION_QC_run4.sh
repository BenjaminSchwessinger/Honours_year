...
name=Pst79_run4_1d # change to only one run
short=/short/sd34/ap5514
###
INPUT=$short/basecalling/basecalled_albacore2110
OUTPUT=$short/basecalling/quality_control/1d_separate_qc/run4
...
cp ${INPUT}/Pst79_[4]/*tar.gz TAR_FILES/. # added basecall files to the node. only one run
