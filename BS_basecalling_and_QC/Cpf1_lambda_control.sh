...
#PBS -P xf3
#PBS -q express 
#PBS -l walltime=14:00:00,mem=126GB,ncpus=16
#PBS -l jobfs=80GB
...
threads=16
genome_file=J02459_1.fasta
genome_folder=/short/xf3/bxs800/MinIon/analysis/Cpf1/genomes
...
cp ${genome_folder}/${genome_file} $PBS_JOBFS/${genome_file}
